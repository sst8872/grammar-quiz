...
var app = function () {
  ...
  function questioner() {
    ...
    if (game.page >= game.totalQuestions) {
      ...
      var hText = document.createTextNode("".concat(holder.question));
  ...
  function loadJSON() {
    ...
    for (var sheetNum = 1; sheetNum <= 3; sheetNum++) {
    ...
    Promise.all(urls.map(function (url) {
      ...
      // Make global data object from spreadsheets
